...
.style8 {color: #FF0000; font-size: 18; }
.style9 {font-size: 18}
-->
</style>
</head>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		<h2 class="style3" >Manage Account !!! </h2>
          <p class="infopost">&nbsp;</p>
          <h2 align="center" class="style3" ><a href="U_Create_Account.jsp">Create Account</a> </span></span></span></p>
            <p align="center" class="style8"><a href="U_Add_Money.jsp">Add Money</a>              </p>
            <p align="center" class="style8"><a href="U_View_Account_Details.jsp">View Account</a>              </p>
            <p align="center" class="style8"><a href="U_View_Transaction.jsp">View Transactions Statement </a></span>        </p>
            
            <p align="center" class="style8"><a href="usermain.jsp">Back</a></p>
          </h2>
        </div>
      </div>
      <div class="sidebar">
