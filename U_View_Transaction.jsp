...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		<h2 class="style3" >View Transactions !!! </h2>
          <p class="infopost">&nbsp;</p>
 ...
 <%@ page import="java.sql.*"%> 
	...
	<table width="545" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
            <tr bgcolor="#00FF33">
              <td width="108" height="30" bgcolor="#FF0000"><div align="center" class="style8 style25 style21 style4"><strong>id</strong></div></td>
              <td width="171" bgcolor="#FF0000"><div align="center" class="style8 style26 style4"><strong>product Name</strong></div></td>
		      <td width="171" bgcolor="#FF0000"><div align="center" class="style8 style26 style4"><strong>Date</strong></div></td>
		      <td width="171" bgcolor="#FF0000"><div align="center" class="style8 style26 style4"><strong>Price</strong></div></td>
			   <td width="171" bgcolor="#FF0000"><div align="center" class="style8 style26 style4"><strong>E-Commerce Website</strong></div></td>
              <%	  
...
%>
          ...
          <p align="justify"><a href="usermain.jsp">Back</a></p>
        </div>
        </div>
      <div class="sidebar">
