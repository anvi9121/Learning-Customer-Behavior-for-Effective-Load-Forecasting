  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		<h2 ><em>User Profile Details </em></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
...
<%@ page import="org.bouncycastle.util.encoders.Base64"%>
				 ...
				 <input  name="image" type="image" src="profile_pic.jsp?id=<%=i%>&type=<%="user"%>" style="width:200px; height:200px;"/></div></td>
					...
					<tr>
					  <td  width="127" height="50" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><div align="left" class="style3 style8 style7 style14" style="margin-left:20px;"><strong>Name</strong></div></td>
	  <td  width="182" valign="middle" height="48" ><div align="left" class="style11" style="margin-left:20px;"><%out.println(s1);%></div></td>
					</tr>
					<tr>
					  <td  width="127" height="48" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><div align="left" class="style3 style8 style7 style14" style="margin-left:20px;"><strong>E-Mail</strong></div></td>
					  <td  width="182" valign="middle" height="48" ><div align="left" class="style11" style="margin-left:20px;"><%out.println(s2);%></div></td>
					</tr>
					<tr>
					  <td  width="127" height="51" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><div align="left" class="style3 style8 style7 style14" style="margin-left:20px;"><strong>Mobile</strong></div></td>
					  <td  width="182" valign="middle" height="51"><div align="left" class="style11" style="margin-left:20px;"><%out.println(s3);%></div></td>
					</tr>
					<tr>
<td  width="127" height="46" align="left" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><div align="left" class="style3 style8 style7 style14" style="margin-left:20px;"><strong>Date Of Birth</strong></div> </td>                    	
<td  width="182" align="left" valign="middle" height="46"><div align="left" class="style11" style="margin-left:20px;"><%out.println(s4);%></div></td>
					...
					<tr>
					  <td  width="127" height="59" align="left" valign="middle" bgcolor="#FF0000" style="color: #00CC99;"><div align="left" class="style3 style8 style7 style14" style="margin-left:20px;"><strong>Address</strong></div></td>
