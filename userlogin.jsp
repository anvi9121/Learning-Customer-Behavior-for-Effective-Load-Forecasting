    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="adminlogin.jsp"><span>Seller</span></a></li>
        </ul>
      </div>
      <div class="logo">
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p><img src="images/Login.png" width="224" height="145" /></p>
          <div class="clr"></div>
		  <form action="authentication.jsp?type=<%="user"%>" method="post">
		  
          <table width="480">
            <tr>
              <td width="162" height="48" bgcolor="#FFFF00"><span class="style7 style4">User Name (required)</span></td>
                    <td width="347"><input id="name" name="userid" class="text" /></td>
            </tr>
            <tr>
              <td height="44" bgcolor="#FFFF00"><span class="style7 style4">Password (required)</span></td>
